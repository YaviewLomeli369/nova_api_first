    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('pendiente', 'Pendiente'), ('aprobada', 'Aprobada'), ('parcial', 'Recibida Parcial'), ('recibida', 'Recibida Completa'), ('pagada', 'Pagada'), ('cancelada', 'Cancelada')], default='pendiente', max_length=20)),
                ...
                ('presupuesto_total', models.DecimalField(blank=True, decimal_places=2, help_text='Presupuesto asignado a esta compra (si aplica)', max_digits=14, null=True)),
