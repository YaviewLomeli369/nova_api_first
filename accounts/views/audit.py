...
# from accounts.serializers.auditoria_serializers import AuditoriaSerializer
# from accounts.filters import AuditoriaFilter
# from accounts.permissions import IsSuperAdmin, IsAuditor
...
# # ✅ Exportar auditoría a CSV (solo Auditor o SuperAdmin)
# class AuditLogExportCSV(APIView):
#     permission_classes = [IsSuperAdmin | IsAuditor]
#     serializer_class = EmptySerializer
...
# # ✅ Mostrar últimas 50 acciones del usuario autenticado (historial personal)
# class ActivityLogView(APIView):
#     permission_classes = [IsAuthenticated]
#     queryset = Auditoria.objects.all()
#     serializer_class = AuditoriaSerializer
...
# # ✅ Ver últimas 200 auditorías (solo Auditor o SuperAdmin)
# class AuditLogView(APIView):
#     permission_classes = [IsSuperAdmin | IsAuditor]
...
# # ✅ Vista paginada y filtrable para el log completo (Auditor o SuperAdmin)
# class StandardResultsSetPagination(PageNumberPagination):
#     page_size = 25
#     page_size_query_param = 'page_size'
#     max_page_size = 100
